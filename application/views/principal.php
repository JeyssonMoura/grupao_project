...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="Assets/css/aux_estilo.css" type="text/css">
        <!-- Bootstrap CSS -->
    ...
    <body>
        <div class="container">
            <!-- Cabeçalho -->
            <div class="m-4"> 
                <div class="d-flex justify-content-center" ><h1>GRU<img src="Assets/img/icone_pao.png" alt="Pão"></h1></div>
                <p class="lead" align="center">Bem-vindo(a) ao GRUPÃO, inicie ou participe de uma discussão.</p>
            </div>
            <!-- Criar Discussão -->
            <div class="card bg-light mb-3">
                <h5 class="box-titulo"><img src="Assets/img/icone_balao_fala.png">Crie uma Discussão</h5>
                <form class="p-2">
                    <div class="form-group">
                        <input type="text" class="form-control" id="titulo-discussao" placeholder="Título da discussão...">
                    </div>
                    <button type="button" class="botao mt-2 btn-block"><img src="Assets/img/icone_enviar.png">Publicar</button>
                </form>
            </div>
            <?php for ($i = 0; $i < 1; $i++) { ?>
                <!-- Discursão --> 
                <div class="card bg-light mb-3">
                    <h5 class="box-titulo"><img src="Assets/img/icone_grupo.png">Título aqui</h5>
                    <!-- Comentários -->
